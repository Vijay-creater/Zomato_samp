        ...
        return (
            <div>
                ...
                <div className="container" style={{}}>
                    <img src="https://www.pixelstalk.net/wp-content/uploads/2016/08/Pictures-HD-Food-Download.jpg" className="detail-img" alt="restaurant-image" width="100%" height="352px" style={{ marginTop: "50px" }} />
                    ...
                    >
                        ...
                        <div>
                            <Carousel showThumbs={false}>
                                <div>
                                    <img src="https://th.bing.com/th/id/R.99a429149891b8331ab9a4d9dcdeca89?rik=ZFGjK2aI0XNcog&riu=http%3a%2f%2fwww.pixelstalk.net%2fwp-content%2fuploads%2f2016%2f08%2fFresh-hot-delicious-food-wallpaper.jpg&ehk=YcpVrjnOnSm%2fhnTl3VFd3ve98wBRCKiyDEZj%2fJ43ix8%3d&risl=&pid=ImgRaw&r=0" className="carousel-image" />
                                </div>
                                <div>
                                    <img src="https://www.pixelstalk.net/wp-content/uploads/2016/08/Pictures-HD-Food-Download.jpg" className="carousel-image" />
                                </div>
                                <div>
                                    <img src="https://th.bing.com/th/id/OIP.flJzzqdpzl5N9WniwzVlYgHaE8?rs=1&pid=ImgDetMain" className="carousel-image" />
                                </div>
                                <div>
                                    <img src="https://imgmedia.lbb.in/media/2019/08/5d662c8ea84656a7661be92a_1566977166741.jpg" className="carousel-image" />
                                </div>
                                <div>
                                    <img src="https://wallpapercave.com/wp/wp3376127.jpg" className="carousel-image" />
                                </div>
                                <div>
                                    <img src="https://th.bing.com/th/id/OIP.xnOdHsT-Ny1NUwz1uv5r-AHaFj?rs=1&pid=ImgDetMain" className="carousel-image" />
                                </div>
                            </Carousel>
                        </div>
                    </Modal>
